...
import 'package:eticaret_mobil_app/views/screens/auth/forgot_password_screen.dart';
import 'package:eticaret_mobil_app/views/screens/auth/signup_screen.dart';
import 'package:eticaret_mobil_app/views/screens/bottom_navbar.dart';
        ...
        child: Column(
          ...
          children: [
           ...
           InkWell(
            ...
            child: Text('Parolanızı mı unuttunuz?',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15),)),
          ],
        ),
      ),
    );
